...
#train = "./my-dataset/many/train/"
test = "./my-dataset/many/test/"
...
def saveImage(X, cls, i):
    ...
    if not os.path.isdir("./pre-dataset/many/"):
        os.mkdir("./pre-dataset/many/")
    if not os.path.isdir("./pre-dataset/many/test/"):
        os.mkdir("./pre-dataset/many/test/")
    if not os.path.isdir("./pre-dataset/many/test/" + cls + "/"):
        os.mkdir("./pre-dataset/many/test/" + cls + "/")
    
    new_img = array_to_img(X.reshape(100,100,3))
    new_img.save("./pre-dataset/many/test/"+ cls + "/" + str(i) + ".jpg")
